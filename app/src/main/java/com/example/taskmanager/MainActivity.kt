...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val list : ListView = findViewById(R.id._dynamic)
        ...
        val addingBtn = findViewById<Button>(R.id.addingButton)
        val executingBtn = findViewById<Button>(R.id.executingButton)
